...
export class AddressSeeder implements OnModuleInit {
    ...
    async onModuleInit() {
        ...
        if (exist.length > 0) {
            console.log('Saltando proceso del seeder -> (Address). Ya existen registros en la base de datos.');
            return;
        }
        console.log('Iniciando el seeder -> (Address). Cargando registros en la base de datos.');
