...
export class OcupationController {
  ...
  findOcupationById(
    ...
    return this._ocupationService.findOcupationById(id, req.user);
  }

  @Post()
  @HttpCode(HttpStatus.CREATED)
  async create(@Body() ocupationData: CreateOcupationDto, @Request() req: any) {
    console.log('personTypeData', ocupationData);
    return await this._ocupationService.create(ocupationData, req.user);
  }
