...
export class RolSeeder implements OnModuleInit {
    ...
    async onModuleInit() {
        ...
        if (exist.length > 0) {
            console.log('Saltando proceso del seeder -> (Rol). Ya existen registros en la base de datos.');
            return;
        }
        console.log('Iniciando el seeder -> (Rol). Cargando registros en la base de datos.');
