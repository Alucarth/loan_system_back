...
import { CreateUserRolDto } from "src/controllers/user_rol/user_rol.dto";
...
export class UserRolSeeder implements OnApplicationBootstrap {
    ...
    async onApplicationBootstrap() {
        ...
        if (exist.length > 0) {
            console.log('Saltando proceso del seeder -> (UserRol). Ya existen registros en la base de datos.');
            return;
        }
        console.log('Iniciando el seeder -> (UserRol). Cargando registros en la base de datos.');
